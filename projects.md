...
<i class="fab fa-researchgate" aria-hidden="true"></i> NusaX: Multilingual Parallel Sentiment Dataset for 10 Indonesian Local Language (Winata et al., 2022) [PDF](https://arxiv.org/pdf/2205.15960.pdf){: .btn .btn--success .btn--small } [Dataset](https://github.com/IndoNLP/nusax){: .btn .btn--danger .btn--small }
