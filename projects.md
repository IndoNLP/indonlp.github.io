...
<i class="fas fa-book" aria-hidden="true"></i> NusaX: Multilingual Parallel Sentiment Dataset for 10 Indonesian Local Language (Winata et al., 2022) [PDF](https://arxiv.org/pdf/2205.15960.pdf){: .btn .btn--success .btn--small } {: .notice}

<i class="fas fa-database" aria-hidden="true"></i> [https://github.com/IndoNLP/nusax](https://github.com/IndoNLP/nusax) {: .primary}
